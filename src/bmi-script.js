...
function updateCategoryBar(bmi) {
  ...
  if (categoryIndex !== -1) {
    ...
    const pointerPosition = categoryIndex * categoryWidth + ((bmi - categories[categoryIndex].min) / (categories[categoryIndex].max - categories[categoryIndex].min + 1)) * categoryWidth;
